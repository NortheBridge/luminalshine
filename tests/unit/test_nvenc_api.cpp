...
namespace {
  ...
  constexpr uint32_t kApi13_1 = nvenc::api::make_api_version(13U, 1U);

}  // namespace

TEST(NvencApiTest, CodecApiCandidatesMatchCompatibilityPlan) {
  EXPECT_THAT(nvenc::api::codec_api_candidates(0), testing::ElementsAre(kApi13_1, kApi13_0, kApi12_2, kApi12_1, kApi12_0, kApi11_0));
  EXPECT_THAT(nvenc::api::codec_api_candidates(1), testing::ElementsAre(kApi13_1, kApi13_0, kApi12_2, kApi12_1, kApi12_0, kApi11_0));
  EXPECT_THAT(nvenc::api::codec_api_candidates(2), testing::ElementsAre(kApi13_1, kApi13_0, kApi12_2, kApi12_1));
...
TEST(NvencApiTest, FilterToApiVersionRetainsReviewedFallbacksForSdk130) {
  ...
  // A 13.0-max ceiling (e.g. compiled against 13.0 headers) must drop the 13.1 candidate.
  EXPECT_THAT(
    nvenc::api::filter_to_api_version({kApi13_1, kApi13_0, kApi12_2, kApi12_1, kApi12_0, kApi11_0}, kApi13_0),
    testing::ElementsAre(kApi13_0, kApi12_2, kApi12_1, kApi12_0, kApi11_0)
  );
}
...
TEST(NvencApiTest, DriverCompatibilityUsesSemanticVersionOrdering) {
  ...
  // Driver capped at 13.0 must reject a 13.1 attempt (the negotiation-fallback scenario).
  EXPECT_FALSE(nvenc::api::driver_supports_api_version(kApi13_0, kApi13_1));
  EXPECT_TRUE(nvenc::api::driver_supports_api_version(kApi13_1, kApi13_0));
  EXPECT_TRUE(nvenc::api::driver_supports_api_version(kApi13_1, kApi13_1));
}
...
TEST(NvencApiTest, ReviewedApiVersionsIncludeSupportedFallbacks) {
  ...
  EXPECT_TRUE(nvenc::api::is_reviewed_api_version(kApi13_1));
  EXPECT_FALSE(nvenc::api::is_reviewed_api_version(nvenc::api::make_api_version(13U, 2U)));
...
TEST(NvencApiTest, SplitFrameSupportStartsAtSdk121) {
  ...
  EXPECT_TRUE(nvenc::api::supports_implicit_split_frame(kApi13_1));
}
...
TEST(NvencApiTest, SeparateBitDepthFieldsStartAtSdk121) {
  ...
  EXPECT_TRUE(nvenc::api::supports_separate_bit_depth_fields(kApi13_1));
}
...
TEST(NvencApiTest, StructVersionMappingsMatchReviewedValues) {
  ...
  EXPECT_EQ(nvenc::api::function_list_version(kApi13_1), nvenc::api::make_struct_version(kApi13_1, 2U));
  ...
  EXPECT_EQ(nvenc::api::initialize_params_version(kApi13_1), nvenc::api::make_struct_version(kApi13_1, 7U, true));
  ...
  EXPECT_EQ(nvenc::api::config_version(kApi13_1), nvenc::api::make_struct_version(kApi13_1, 9U, true));
  ...
  EXPECT_EQ(nvenc::api::preset_config_version(kApi13_1), nvenc::api::make_struct_version(kApi13_1, 5U, true));
  ...
  EXPECT_EQ(nvenc::api::reconfigure_params_version(kApi13_1), nvenc::api::make_struct_version(kApi13_1, 2U, true));
  ...
  EXPECT_EQ(nvenc::api::pic_params_version(kApi13_1), nvenc::api::make_struct_version(kApi13_1, 7U, true));
  ...
  EXPECT_EQ(nvenc::api::register_resource_version(kApi13_1), nvenc::api::make_struct_version(kApi13_1, 5U));
}
...
TEST(NvencApiTest, LockBitstreamVersionHandlesSdkSpecificShapeChanges) {
  ...
  EXPECT_EQ(nvenc::api::lock_bitstream_version(kApi13_1), nvenc::api::make_struct_version(kApi13_1, 2U, true));
}

TEST(NvencApiTest, EventParamsVersionBumpsAtSdk130AndStaysAtTwo) {
  ...
  EXPECT_EQ(nvenc::api::event_params_version(kApi13_1), nvenc::api::make_struct_version(kApi13_1, 2U));
}
